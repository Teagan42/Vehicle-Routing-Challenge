...
class ShortestJobRoutingStrategy(BaseRoutingStrategy):
    ...
    def get_next_load_index(
        ...
        """
        Finds the next job that can be completed in the shortest amount of time between pickup and dropoff
        ...
        def calculate_distance(load_number: int) -> float:
            ...
            return next_load.distance_to_dropoff
